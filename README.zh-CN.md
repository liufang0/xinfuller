...
<p>
  <a href="https://www.doubao.com/">OpenIM Docs</a>
  •
...
同时，您需要确保已经[部署](https://www.doubao.com/zh-Hans/guides/gettingStarted/dockerCompose)了最新版本的 OpenIM Server。接下来，您可以编译项目并连接自己的服务端进行测试。
